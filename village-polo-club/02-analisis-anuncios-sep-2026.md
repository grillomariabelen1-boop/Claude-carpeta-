...
**Relevado en la tienda el 24/9** (detalle en [`04-auditoria-tienda-sep-2026.md`](04-auditoria-tienda-sep-2026.md)): una prenda
cuesta $7.885 a CABA y entre $9.455 y $11.920 al interior. Sobre una chomba de $49.900, un 20% más.

Opciones, de más barata a más cara:

1. ~~**Mostrar el costo antes.** Activar el calculador de envío en la página de producto.~~ **Ya está activo.**
2. ~~**Comunicar el umbral en el carrito.**~~ **Ya está** (barra "te faltan $X"). La barra superior también lo dice. Falta en los anuncios.
2b. **Bajar el umbral a $149.000.** Hoy tres prendas de $49.900 suman $149.700 y pagan envío.
2c. **Corregir el punto de retiro**, que se cobra (hasta $46.541) aun en compras con envío gratis.
...
- [x] Qué son los "ambos" y a qué precio: trajes de $199.000 (lavable) a $589.000 (Hechter). Falta cuánto pesan en la venta
- [x] Costo de envío por debajo de $150.000 y opciones de envío que ve el cliente en el checkout (ver `04-auditoria-tienda-sep-2026.md`)
